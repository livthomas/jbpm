...
public class HumanTaskAssignmentTest extends JbpmTestCase {
    ...
    /**
     * Bug 1103977 - CommandBasedTaskService.getTasksAssignedAsPotentialOwner(String userId, List<String> groupIds,
     * String language) doesn't use groupIds
     *
     * @see <a href="https://bugzilla.redhat.com/show_bug.cgi?id=1103977">Bug 1103977</a>
     */
    @Test
    ...
    /**
     * Bug 1178153 - testWithNoTaskAndEmptyLists(org.jbpm.services.task.LifeCycleLocalCommandBasedTest) fails with
     * Sybase15.7 on SQLException: Incorrect syntax near ')'
     *
     * @see <a href="https://bugzilla.redhat.com/show_bug.cgi?id=1178153">Bug 1178153</a>
     */
    @Test
