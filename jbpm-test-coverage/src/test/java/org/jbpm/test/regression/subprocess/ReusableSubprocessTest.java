...
public class ReusableSubprocessTest extends JbpmTestCase {
    ...
    /**
     * Bug 1194180 - SessionNotFoundException when using Reusable sub-process with [Wait For Completion] = false
     * and Per_Process_Instance strategy
     *
     * @see <a href="https://bugzilla.redhat.com/show_bug.cgi?id=1194180">Bug 1194180</a>
     */
    @Test
    ...
    /**
     * Bug 1128597 - PerProcessInstanceRuntimeManager fails with dependent subprocess abort
     *
     * @see <a href="https://bugzilla.redhat.com/show_bug.cgi?id=1128597">Bug 1128597</a>
     */
    @Test
