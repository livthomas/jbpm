...
/**
 * BRMS-BPM-08 Subprocesses
 */
public class SubprocessesTest extends JbpmTestCase {
    private static final Logger LOGGER = LoggerFactory.getLogger(SubprocessesTest.class);
    ...
    private static final String HELLO_WORLD_PROCESS = "org/jbpm/test/functional/common/Common-helloWorldProcess1.bpmn";
    ...
    private static final String HELLO_WORLD_PROCESS_ID = "org.jbpm.test.functional.common.Common-helloWorldProcess1";
