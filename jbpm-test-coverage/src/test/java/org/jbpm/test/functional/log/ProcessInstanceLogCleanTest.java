...
public class ProcessInstanceLogCleanTest extends JbpmTestCase {
    ...
    private static final String HELLO_WORLD_PROCESS2 =
            "org/jbpm/test/functional/common/Common-helloWorldProcess2.bpmn";
    private static final String PARENT_PROCESS_INFO =
            "org/jbpm/test/functional/common/Common-parentProcessInfo.bpmn2";
    private static final String PARENT_PROCESS_CALLER =
            "org/jbpm/test/functional/common/Common-parentProcessInfo-Caller.bpmn2";
    ...
    private static final String HELLO_WORLD_PROCESS2_ID =
            "org.jbpm.test.functional.common.Common-helloWorldProcess2";
    private static final String PARENT_PROCESS_INFO_ID =
            "org.jbpm.test.functional.common.Common-parentProcessInfo";
    private static final String PARENT_PROCESS_CALLER_ID =
            "org.jbpm.test.functional.common.Common-parentProcessInfo-Caller";
    private static final String HUMAN_TASK_ID =
            "org.jbpm.test.functional.common.Common-humanTask";

    private static final String HELLO_WORLD_P1NAME = "Common-helloWorldProcess1";
    private static final String HELLO_WORLD_P2NAME = "Common-helloWorldProcess2";
    ...
    /**
     * Bug 1192498 - JPAAuditLogService queries with data ranges do not work well.
     *
     * @see <a href="https://bugzilla.redhat.com/show_bug.cgi?id=1192498" />
     */
    @Test
