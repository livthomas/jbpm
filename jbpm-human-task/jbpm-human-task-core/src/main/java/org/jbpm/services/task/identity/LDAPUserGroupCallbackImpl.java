 ...
 * <li>ldap.role.attr.id (optional, if not given 'cn' will be used)</li>
...
public class LDAPUserGroupCallbackImpl extends AbstractLDAPUserGroupInfo implements UserGroupCallback {
    ...
    public static final String USER_ID_DN = "ldap.user.id.dn";
    ...
    private boolean isUserIdDn() {
        return Boolean.parseBoolean(getConfigProperty(USER_ID_DN, DEFAULT_USER_ID_DN));
    }
